      ...
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4
       flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm "
        ...
        <ul className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3
          ...
          <li><a className='font-ovo font-medium' href="#contact">Contact me</a></li>
        </ul>
        ...
        >
          ...
          <li><a className='font-ovo font-medium' onClick={closeMenu} href="#top">Home</a></li>
          <li><a className='font-ovo font-medium' onClick={closeMenu} href="#about">About me</a></li>
          <li><a className='font-ovo font-medium' onClick={closeMenu} href="#services">Services</a></li>
          <li><a className='font-ovo font-medium' onClick={closeMenu} href="#work">My Work</a></li>
          <li><a className='font-ovo font-medium' onClick={closeMenu} href="#contact">Contact me</a></li>
        </ul>
      </nav>
    </>
  )
